...
//
  ...
  #define X_DIAG_PIN                        PF15  //PC9 //(PC9)->SERVO1_PIN   //  PB10  // X-
  #define Y_DIAG_PIN                        PF15  //PC9 //(PC9)->SERVO1_PIN   //  PE12  // Y-
  #define Z_DIAG_PIN                        PF15  //PC9 //(PC9)->SERVO1_PIN   //  PG8   // Z-
  #define E0_DIAG_PIN                       PF15  //PC9 //(PC9)->SERVO1_PIN   //  PE15  // E0
  #define E1_DIAG_PIN                       PF15  //PC9 //(PC9)->SERVO1_PIN   //  PE10  // E1
  #define E2_DIAG_PIN                       PF15  //PC9 //(PC9)->SERVO1_PIN   //  PG5   // E2
#endif
